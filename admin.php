 ...
 <li>
                 ...
                 <li>
                    ...
                    <li>
                     ...
                     <li>
                        <a  href="?page=data_blok_b"><i class="fa fa-table fa-2x"></i> AUNING BLOK B<span class="fa arrow"></span></a>
                        <ul class="nav nav-third-level">


                    <li>
                        <a  href="?page=data_blok_b"><i class="fa fa-table fa-2x"></i> AUNING BLOK B  (TEMPAT JUALAN MAKANAN)</a>
                    </li>
                    ...
                    <li>
                        <a  href="?page=data_blok_c1"><i class="fa fa-table fa-2x"></i> LOS PAPAN BLOK C1 (TEMPAT JUALAN IKAN)</a>
                    </li>

                    <li>
                        <a  href="?page=data_blok_c2"><i class="fa fa-table fa-2x"></i> LOS PAPAN BLOK C2 (TEMPAT JUALAN IKAN)</a>
                    </li>

                    <li>
                        <a  href="?page=data_blok_c3"><i class="fa fa-table fa-2x"></i> LOS PAPAN BLOK C3  (TEMPAT JUALAN IKAN)</a>
                    </li>
                    ...
                    <?php error_reporting(0);
                        ...
                        if ($page == "data_suplier") {
                          ...
                          elseif ($aksi == "simpan"){
                           ...
                           }elseif ($page == "data_blok_a"){
                          if ($aksi == ""){
                            include "page/data_blok_a/data_blok_a.php";
                          }elseif ($aksi == "tambah"){
                            include "page/data_blok_a/tambah.php";
                          }elseif ($aksi == "ubah"){
                            include "page/data_blok_a/ubah.php";
                          }elseif ($aksi == "hapus"){
                            include "page/data_blok_a/hapus.php";
                          }
                          elseif ($aksi == "simpan_ubah"){
                            include "page/data_blok_a/simpan_ubah.php";
                          }
                          elseif ($aksi == "simpan"){
                            include "page/data_blok_a/simpan.php";
                          }

                           }elseif ($page == "data_blok_b"){
                          if ($aksi == ""){
                            include "page/data_blok_b/data_blok_b.php";
                          }elseif ($aksi == "tambah"){
                            include "page/data_blok_b/tambah.php";
                          }elseif ($aksi == "ubah"){
                            include "page/data_blok_b/ubah.php";
                          }elseif ($aksi == "hapus"){
                            include "page/data_blok_b/hapus.php";
                          }
                          elseif ($aksi == "simpan_ubah"){
                            include "page/data_blok_b/simpan_ubah.php";
                          }
                          elseif ($aksi == "simpan"){
                            include "page/data_blok_b/simpan.php";
                          }


                           }elseif ($page == "data_blok_c1"){
                          if ($aksi == ""){
                            include "page/data_blok_c1/data_blok_c1.php";
                          }elseif ($aksi == "tambah"){
                            include "page/data_blok_c1/tambah.php";
                          }elseif ($aksi == "ubah"){
                            include "page/data_blok_c1/ubah.php";
                          }elseif ($aksi == "hapus"){
                            include "page/data_blok_c1/hapus.php";
                          }
                          elseif ($aksi == "simpan_ubah"){
                            include "page/data_blok_c1/simpan_ubah.php";
                          }
                          elseif ($aksi == "simpan"){
                            include "page/data_blok_c1/simpan.php";
                          }

                           }elseif ($page == "data_blok_c2"){
                          if ($aksi == ""){
                            include "page/data_blok_c2/data_blok_c2.php";
                          }elseif ($aksi == "tambah"){
                            include "page/data_blok_c2/tambah.php";
                          }elseif ($aksi == "ubah"){
                            include "page/data_blok_c2/ubah.php";
                          }elseif ($aksi == "hapus"){
                            include "page/data_blok_c2/hapus.php";
                          }
                          elseif ($aksi == "simpan_ubah"){
                            include "page/data_blok_c2/simpan_ubah.php";
                          }
                          elseif ($aksi == "simpan"){
                            include "page/data_blok_c2/simpan.php";
                          }
